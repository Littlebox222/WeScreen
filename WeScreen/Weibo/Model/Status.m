...
- (void)dealloc
{
    ...
    [_text release];
    [_source release];
    [_inReply2StatusId release];
    [_inReply2UserId release];
    [_inReply2ScreenName release];
    [_mlevel release];
    ...
    [_visibleType release];
    [_visibleListId release];
    [super dealloc];
}
...
{
    Status *aStatus = [[[Status alloc] init] autorelease];
