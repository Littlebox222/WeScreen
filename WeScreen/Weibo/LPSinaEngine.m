                        ...
                        success:(void (^) (BOOL isSuccess, NSMutableArray *array))isSuccess
{
    ...
    [HttpBaseModel getDataResponseHostName:HOSTURL Path:@"2/comments/show.json" params:dic httpMethod:@"GET" onCompletion:^(NSData *responseData){
        ...
        NSMutableArray *commentArray = [[[NSMutableArray alloc] initWithCapacity:0] autorelease];
        for (NSDictionary *dic in array) {
                             ...
                             success:(void (^) (BOOL isSuccess, NSMutableArray *array, NSString *nextCursor, NSString *previousCursor, NSString *totalNumber))isSuccess
{
    ...
    [HttpBaseModel getDataResponseHostName:HOSTURL Path:path params:dic httpMethod:@"GET" onCompletion:^(NSData *responseData){
        ...
        NSMutableArray *usersArray = [[[NSMutableArray alloc] initWithCapacity:0] autorelease];
        for (NSDictionary *dic in array) {
                    ...
                    success:(void (^) (BOOL isSuccess, NSMutableArray *array))isSuccess
{
    ...
    [HttpBaseModel getDataResponseHostName:HOSTURL Path:path params:dic httpMethod:@"GET" onCompletion:^(NSData *responseData){
        ...
        NSArray *array = nil;
        if (flag == 1) {
            array = [json objectWithString:responseString error:&error];
        }
        else{
            NSDictionary *jsonDic = [json objectWithString:responseString error:&error];
        ...
        NSMutableArray *favoriteArray = [[[NSMutableArray alloc] initWithCapacity:0] autorelease];
        for (NSDictionary *dic in array) {
                  ...
                  success:(void (^) (BOOL isSuccess, NSMutableArray *array))isSuccess
{
    ...
    [HttpBaseModel getDataResponseHostName:HOSTURL Path:path params:dic httpMethod:@"GET" onCompletion:^(NSData *responseData){
        ...
        NSMutableArray *trendsArray = [[[NSMutableArray alloc] initWithCapacity:0] autorelease];
                         ...
                         success:(void (^) (BOOL isSuccess, NSMutableArray *array))isSuccess
{
    ...
    [HttpBaseModel getDataResponseHostName:HOSTURL Path:path params:dic httpMethod:@"GET" onCompletion:^(NSData *responseData){
        ...
        NSMutableArray *suggestArray = [[[NSMutableArray alloc] initWithCapacity:0] autorelease];
        for (NSDictionary *dic in jsonArray) {
            id suggest = nil;
            if (flag == 1) {
                ...
                NSString *str2 = [[[NSString alloc] initWithData:data  encoding:NSUTF8StringEncoding] autorelease];
                suggest = str2;
            }
            else if (flag == 3) {
                   ...
                   success:(void (^) (BOOL isSuccess, NSMutableArray *array))isSuccess
{
    ...
    [HttpBaseModel getDataResponseHostName:HOSTURL Path:path params:dic httpMethod:@"GET" onCompletion:^(NSData *responseData){
        ...
        NSMutableArray *urlsArray = [[[NSMutableArray alloc] initWithCapacity:0] autorelease];
        for (NSDictionary *dic in array) {
                          ...
                          success:(void (^) (BOOL isSuccess, NSMutableArray *array))isSuccess
{
    ...
    [HttpBaseModel getDataResponseHostName:HOSTURL Path:@"2/place/nearby/pois.json" params:dic httpMethod:@"GET" onCompletion:^(NSData *responseData){
        ...
        NSMutableArray *poisArray = [[[NSMutableArray alloc] initWithCapacity:0] autorelease];
        for (NSDictionary *dic in array) {
                       ...
                       success:(void (^) (BOOL isSuccess, NSMutableArray *array))isSuccess
{
    ...
    [HttpBaseModel getDataResponseHostName:HOSTURL Path:path params:dic httpMethod:@"GET" onCompletion:^(NSData *responseData){
        ...
        if (flag == 0) {
            ...
            NSArray *array = [jsonDic objectForKey:@"statuses"];
            NSMutableArray *statusesArray = [[[NSMutableArray alloc] initWithCapacity:0] autorelease];
            for (NSDictionary *dic in array) {
                Status *status = [Status getStatusFromJsonDic:dic];
