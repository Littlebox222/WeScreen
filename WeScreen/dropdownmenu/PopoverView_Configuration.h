...
#define kGradientBottomColor [UIColor colorWithRed:48/255.0 green:49/255.0 blue:51/255.0 alpha:kBoxAlpha]

//top color white value in gradient bg
#define kGradientTopColor [UIColor colorWithRed:48/255.0 green:49/255.0 blue:51/255.0 alpha:kBoxAlpha]
